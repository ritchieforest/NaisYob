            ...
            <div class="arrivals-grids">
              <div class="col-md-3 arrival-grid simpleCart_shelfItem" style="position: absolute;  left: 50px;">
                <div class="grid-arr">
                  ...
                  <div class="women">
                    <h6><a href="single.html">Ingeniero Pablo Saucedo</a></h6>
                    <a href="#" data-text="Add To Cart" class="my-cart-b item_add">Ver Perfil</a>
                  </div>
                </div>
              </div>
              <div class="col-md-3 arrival-grid simpleCart_shelfItem" style="position: absolute;  left: 370px;" >
                <div class="grid-arr">
                  <div  class="grid-arrival">
                    <figure>    
                      <a href="#" class="new-gri" data-toggle="modal" data-target="#myModal2">
                        <div class="grid-img">
                          <img  src="imagenes/imagen8.jpg" class="img-responsive" alt="">
                        </div>
                        <div class="grid-img">
                          <img  src="imagenes/imagen7.jpg" class="img-responsive"  alt="">
                        </div>      
                      </a>    
                    </figure> 
                    <form>
                  ...
                  <div class="women">
                    <h6><a href="single.html">Mecanico Raul Ortega</a></h6>
                    
                    <a href="#" data-text="Add To Cart" class=" my-cart-b item_add">Ver Perfil</a>
                  </div>
                </div>
              </div>
              <div class="col-md-3 arrival-grid simpleCart_shelfItem"  style="position: absolute;  left: 690px; ">
                <div class="grid-arr">
                  <div  class="grid-arrival">
                    <figure>    
                      <a href="#" class="new-gri" data-toggle="modal" data-target="#myModal3">
                        <div class="grid-img">
                          <img  src="imagenes/imagen10.jpg" class="img-responsive" alt="">
                        </div>
                        <div class="grid-img">
                          <img  src="imagenes/imagen9.jpg" class="img-responsive"  alt="">
                        </div>      
                      </a>    
                    </figure>
                    <form>
                  ...
                  <div class="women">
                    <h6><a href="single.html">Abogado Luis Sanabria</a></h6>
                    
                    <a href="#" data-text="Add To Cart" class="my-cart-b item_add">Ver Perfil</a>
                  </div>
                </div>
              </div>
              <div class="col-md-3 arrival-grid simpleCart_shelfItem" style="position: absolute;  left: 1000px;">
                <div class="grid-arr">
                  <div  class="grid-arrival">
                    <figure>    
                      <a href="#" class="new-gri" data-toggle="modal" data-target="#myModal4">
                        <div class="grid-img">
                          <img  src="imagenes/imagen11.jpg" class="img-responsive" alt="">
                        </div>
                        <div class="grid-img">
                          <img  src="imagenes/imagen12.jpg" class="img-responsive"  alt="">
                        </div>      
                      </a>    
                    </figure> 
                    <form>
                  ...
                  <div class="women">
                    <h6><a href="single.html">Albañil Regina Lopez</a></h6>
